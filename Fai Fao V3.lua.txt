--[[
Cảm Ơn Bạn Đã Sử Dụng Script bên mình  Chúc Bạn Có 1 Trải Nghiệm Vui Vẻ.
Nếu Có Lỗi Hoặc Cần Hỗ Trợ Hãy Liên Hệ Trên Web Nhé, Bản này sẽ Anti Band 100%
]]--
----------------------------------------------------------------------------------------------------------------------------------------------
...
local Window = Fluent:CreateWindow({
    Title = "TranHieu HUD",
    SubTitle = "Version Beta by trần hiếu",
    TabWidth = 160,
...
ImageButton.Image = "http://www.roblox.com/asset/?id=101834474628641"
